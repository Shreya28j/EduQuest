...
<head>
    <meta charset="UTF-8">
    <title>Admin Panel - EduQuest</title>
    ...
    <style>
        ...
        .admin-container {
            ...
            max-width: 400px;
            margin-top: 20px;
            animation: containerAnimation 0.8s ease-in-out; /* Added container animation */
        }
...
<body>
    ...
    <div class="admin-container">
        ...
        <p class="admin-instructions">
            Welcome to the Admin Section. Please register if you are a new admin, or log in if you already have an account.
        </p>
        <div class="btn-container">
            <a href="adminRegister.jsp" class="btn btn-register"><i class="fas fa-user-plus"></i> Register</a>
            <a href="adminLogin.jsp" class="btn btn-login"><i class="fas fa-sign-in-alt"></i> Login</a>
        </div>
    </div>
