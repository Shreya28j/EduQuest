...
<body>
    ...
    <div class="container">
       ...
       int candidate_Id = Integer.parseInt(candidateId);
       ...
       try{
           ...
           PreparedStatement p = c.prepareStatement("INSERT INTO candidate (candidate_id, name, password, email, address) VALUES(?, ?, ?, ?, ?)");
           p.setInt(1, candidate_Id);
           p.setString(2, name);
           ...
           if(i == 1){
               out.print("<p class='success-message'>Candidate registered successfully!</p>");
               out.print("<p class='message'>Click here to go to the home page and attend the test.</p>");
               out.print("<a class='button' href='candidateHome.jsp'>Home</a>");
           }
           c.close();
       }
       catch(SQLIntegrityConstraintViolationException e){
           out.print("<p class='error-message'>Error: Candidate ID already exists!</p>");
           out.print("<a class='back-button' href='candidateRegister.jsp'>Go Back to Register</a>");
       }
       catch(Exception e){
