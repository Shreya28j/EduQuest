...
<body>
    ...
    <div class="container">
        ...
        <form action="candidateLogin1.jsp" method="post">
            <label for="candidate_id">Candidate ID:</label>
            <input type="text" id="candidate_id" name="n1" placeholder="Enter your Candidate ID" required>
        ...
        <div class="message">
            Don't have an account? <a href="candidateRegister.jsp">Register here</a>
        </div>
    </div>
